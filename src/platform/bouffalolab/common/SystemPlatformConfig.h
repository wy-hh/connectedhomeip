...
#define CHIP_SYSTEM_HEADER_RESERVE_SIZE (388 + CHIP_SYSTEM_CRYPTO_HEADER_RESERVE_SIZE)
#else
...
#define CHIP_SYSTEM_HEADER_RESERVE_SIZE (48 + CHIP_SYSTEM_CRYPTO_HEADER_RESERVE_SIZE)
#endif
#endif
