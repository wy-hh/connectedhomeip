...
/**
 * Enumerates BL702L platform-specific event types that are visible to the application.
 */
...
/**
 * Enumerates BL702L platform-specific event types that are internal to the chip Device Layer.
 */
...
/**
 * Represents platform-specific event information for the BL702L platform.
 */
