...
/**
 * Concrete implementation of the ConfigurationManager singleton object for the bl702l platform.
 */
class ConfigurationManagerImpl : public Internal::GenericConfigurationManagerImpl<Internal::BL702LConfig>
{
public:
