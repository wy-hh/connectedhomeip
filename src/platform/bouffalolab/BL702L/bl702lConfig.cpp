...
#include <platform/bouffalolab/BL702L/bl702lConfig.h>
...
CHIP_ERROR BL702LConfig::Init()
{
    return CHIP_NO_ERROR;
}

CHIP_ERROR BL702LConfig::ReadConfigValue(const char * key, uint8_t * val, size_t size, size_t & readsize)
{
    env_node_obj node;
...
CHIP_ERROR BL702LConfig::ReadConfigValue(const char * key, bool & val)
{
    size_t readlen = 0;
    return ReadConfigValue(key, (uint8_t *) &val, 1, readlen);
}

CHIP_ERROR BL702LConfig::ReadConfigValue(const char * key, uint32_t & val)
{
    size_t readlen = 0;
    return ReadConfigValue(key, (uint8_t *) &val, sizeof(val), readlen);
}

CHIP_ERROR BL702LConfig::ReadConfigValue(const char * key, uint64_t & val)
{
    size_t readlen = 0;
    return ReadConfigValue(key, (uint8_t *) &val, sizeof(val), readlen);
}

CHIP_ERROR BL702LConfig::ReadConfigValueStr(const char * key, char * buf, size_t bufSize, size_t & outLen)
{
    size_t readlen = 0;
...
CHIP_ERROR BL702LConfig::ReadConfigValueBin(const char * key, uint8_t * buf, size_t bufSize, size_t & outLen)
{
    size_t readlen = 0;
    if (CHIP_NO_ERROR == ReadConfigValue(key, (uint8_t *) buf, bufSize, readlen))
    {
...
CHIP_ERROR BL702LConfig::WriteConfigValue(const char * key, uint8_t * val, size_t size)
{
...
CHIP_ERROR BL702LConfig::WriteConfigValue(const char * key, bool val)
{
    return WriteConfigValue(key, (uint8_t *) &val, sizeof(val));
}

CHIP_ERROR BL702LConfig::WriteConfigValue(const char * key, uint32_t val)
{
    return WriteConfigValue(key, (uint8_t *) &val, sizeof(val));
}

CHIP_ERROR BL702LConfig::WriteConfigValue(const char * key, uint64_t val)
{
    return WriteConfigValue(key, (uint8_t *) &val, sizeof(val));
}

CHIP_ERROR BL702LConfig::WriteConfigValueStr(const char * key, const char * str)
{
    return WriteConfigValue(key, (uint8_t *) str, strlen(str) + 1);
}

CHIP_ERROR BL702LConfig::WriteConfigValueStr(const char * key, const char * str, size_t strLen)
{
    return WriteConfigValue(key, (uint8_t *) str, strLen);
}

CHIP_ERROR BL702LConfig::WriteConfigValueBin(const char * key, const uint8_t * data, size_t dataLen)
{
    return WriteConfigValue(key, (uint8_t *) data, dataLen);
}

CHIP_ERROR BL702LConfig::ClearConfigValue(const char * key)
{
    return EF_NO_ERR == ef_del_env(key) ? CHIP_NO_ERROR : CHIP_DEVICE_ERROR_CONFIG_NOT_FOUND;
}

CHIP_ERROR BL702LConfig::FactoryResetConfig(void)
{
...
void BL702LConfig::RunConfigUnitTest() {}

bool BL702LConfig::ConfigValueExists(const char * key)
{
    env_node_obj node;
...
CHIP_ERROR BL702LConfig::ReadKVS(const char * key, void * value, size_t value_size, size_t * read_bytes_size, size_t offset_bytes)
{
...
CHIP_ERROR BL702LConfig::WriteKVS(const char * key, const void * value, size_t value_size)
{
    EfErrCode ret = EF_NO_ERR;
...
CHIP_ERROR BL702LConfig::ClearKVS(const char * key)
{
    ef_port_env_lock();
...
CHIP_ERROR BL702LConfig::WriteWiFiInfo(const char * ssid, const char * passwd)
{
...
CHIP_ERROR BL702LConfig::ReadWiFiInfo(const char * ssid, uint32_t ssid_size, const char * passwd, uint32_t passwd_size)
{
...
CHIP_ERROR BL702LConfig::ClearWiFiInfo(void)
{
    ef_port_env_lock();
...
bool BL702LConfig::isWiFiInfoSaved()
{
    env_node_obj node;
